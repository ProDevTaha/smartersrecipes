...
<body>
    <div class="card" style="margin-top: 3%; border: 1px solid #ccc; border-radius: 5px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
        ...
        <div class="card-footer" style="padding: 10px; background-color: #f8f9fa; border-top: 1px solid #ccc;">
            ...
            @if (  $thankyou == 'bootcoders' )
              <p>Expect delivery within 1 to 12 hours. Feel free to reach out if you haven't received it by then at email : bootcoders.tv@gmail.com</p>
            @elseif( $thankyou == 'technooiptv')
               <p>Your order will be delivered within a timeframe of 15 minutes to a maximum of 8 hours. If you haven't received your subscription within this time, please contact us via email at  : Technoiptvservice@gmail.com.
               </p>
               <p>We truly appreciate you taking the time to do this today. Thank you for being you.</p>
             @elseif( $thankyou == 'smartersplanet')
